          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                required autoFocus
                className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm outline-none transition-colors focus:border-[#072740]"
              />
            </div>
            <div>
            ...
            <button
              ...
              className="w-full text-sm font-semibold rounded-xl py-2.5 disabled:opacity-50 btn-brand"
            >
